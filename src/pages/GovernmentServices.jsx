...
function GovernmentServices() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const colRef = collection(db, "GovernmentServices");
        ...
        if (!snapshot.empty) {
          ...
          console.log("No data found in GovernmentServices collection.");
        }
      } catch (error) {
  ...
  const handleSave = async () => {
    try {
      ...
      if (formData.id) {
        ...
        await updateDoc(doc(db, "GovernmentServices", id), updateData);
        console.log("Item updated:", id);
      } else {
        const newRef = doc(collection(db, "GovernmentServices"));
  ...
  const handleDelete = async () => {
    try {
      await deleteDoc(doc(db, "GovernmentServices", formData.id));
        ...
        <div className="container py-1">
          <div className="row justify-content-center py-1">
            <div className="col-lg-10 pt-lg-1 mt-lg-5 text-center">
              <h1 className="display-3 text-white animated slideInDown">Government Services</h1>
              <nav aria-label="breadcrumb">
                <ol className="breadcrumb justify-content-center">
                  <li className="breadcrumb-item"><a href="/">Home</a></li>
                  <li className="breadcrumb-item text-white active" aria-current="page">Government Services</li>
                </ol>
              </nav>
            </div>
          </div>
                ...
                <div className="package-item d-flex flex-column">
                  ...
                  <div className="text-center p-4 flex-grow-1">
                    ...
                    <div className="d-flex justify-content-center mb-2">
                      ...
                      state={{ id: pkg.id, category: "GovernmentServices"  }}
